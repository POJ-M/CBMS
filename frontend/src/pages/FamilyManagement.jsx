      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[92vh] flex flex-col overflow-hidden">
        ...
        <div className="overflow-y-auto flex-1 p-5 space-y-4">
          ...
          <FormSection color="yellow" title="Head Believer — Occupation">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className={lbl(!isDeceased)}>Occupation Category</label>
                <select
          ...
          {!isUnder18 && (
            <FormSection color="pink" title="Head Believer — Marital Status">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className={lbl(!isDeceased)}>Marital Status</label>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    {m.gender} · {m.dob && <> · {calcAge(m.dob)} yrs</>}
                    {' '}· {m.memberType} · {m.membershipStatus}
